...
impl Database {
    fn new() -> Self {
        Self { tasks: HashMap::new(), users: HashMap::new() }
    }
...
async fn main() -> std::io::Result<()> {
    // load data, if it don't exists database, creating a new database.
